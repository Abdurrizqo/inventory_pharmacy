            ...
            <div class="bg-white border rounded p-3">
                <form method="POST">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex-1">
                            <input type="hidden" name="obat_id" id="obat_id" value="{{ $stok->obatId }}">
                            <label for="obatName" class="block text-sm ml-2 mb-1">Nama Obat</label>
                            <input type="text" readonly name="obatName" id="obatName" value="{{ $stok->nama_obat }}"
                        ...
                        <div class="w-24">
                            ...
                            <input type="number" name="jumlah_stok" id="jumlah_stok" value="{{ $stok->jumlah_stok }}"
                                class="border border-gray-300 rounded-md outline-none focus:border-emerald-400 px-3 py-1 h-10 w-full">
                        </div>

                        <div class="w-24">
                            <label for="harga_satuan" class="block text-sm ml-2 mb-1">Harga Satuan</label>
                            <input type="number" name="harga_satuan" id="harga_satuan" value="{{ $stok->harga_satuan }}"
                                class="border border-gray-300 rounded-md outline-none focus:border-emerald-400 px-3 py-1 h-10 w-full">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-3 mt-10">
                        <div>
                            ...
                            <input type="date" name="exp_date" id="exp_date" value="{{ $stok->exp_date }}"
                                class="border border-gray-300 rounded-md outline-none px-3 py-1 h-10 w-full">
                        </div>

                        <div>
                            <input type="hidden" name="supplier_id" id="supplier_id" value="{{ $stok->suppliersId }}">
